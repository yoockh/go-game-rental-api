...
import (
	...
	myConfig "github.com/yoockh/go-api-utils/pkg/config"
	"github.com/yoockh/go-game-rental-api/app/echo-server/router"
	_ "github.com/yoockh/go-game-rental-api/docs"
